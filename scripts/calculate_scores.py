...
Hype Score = GitHub star velocity (40%) + HN points (35%) + HN mention count (25%)
...
def calculate_scores(
    ...
    Each tool dict should already have github/pypi/hn fields merged in.
    """
    results = []
    ...
    stars_deltas = [r["stars_delta_7d"] for r in results]
    ...
    norm_stars = normalize_values(stars_deltas)
    ...
    for i, r in enumerate(results):
        hype = norm_stars[i] * 0.4 + norm_hn_pts[i] * 0.35 + norm_hn_cnt[i] * 0.25
